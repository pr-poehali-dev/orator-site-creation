        ...
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>При отмене записи за 10 и более календарных дней до начала курса осуществляется возврат оплаты курса за вычетом стоимости брони.</li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>При отмене записи за 3-9 календарных дней до начала курса возвращается 50% оплаты курса за вычетом стоимости брони.</li>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>В заявлении указать:
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  ...
                  <li>Дату и сумму оплаты курса</li>
