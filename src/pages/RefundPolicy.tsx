      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-3">2.1. Отмена за 7 и более дней до начала курса</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>При отмене записи за 7 и более календарных дней до начала курса осуществляется полный возврат оплаченной суммы (100%).</li>
              <li>Возврат производится в течение 10 рабочих дней на банковскую карту или счет, с которого была произведена оплата.</li>
            </ul>

            <h3 className="text-xl font-bold text-foreground mt-6 mb-3">2.2. Отмена за 3-6 дней до начала курса</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>При отмене записи за 3-6 календарных дней до начала курса возвращается 50% оплаченной суммы.</li>
              <li>Удержанные 50% компенсируют затраты на подготовку материалов и бронирование места.</li>
            </ul>
