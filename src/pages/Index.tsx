  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      >
        <div className="container mx-auto max-w-4xl flex flex-col sm:flex-row items-center justify-center gap-4 text-center sm:text-left">
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <span className="bg-white/20 text-white text-base font-bold px-4 py-1.5 rounded-full uppercase tracking-wide whitespace-nowrap">13 августа</span>
          </div>
          <div className="flex-1">
            <p className="font-bold text-xl md:text-2xl leading-tight">Старт онлайн-интенсива «Запуск блогера»!</p>
            <p className="text-white/85 text-lg mt-1">6 недель от «не знаю как» до «уже снимаю и получаю заявки»</p>
          </div>
      ...
      <ApplicationModal
        ...
        courseName="Онлайн-интенсив «Запуск блогера»"
        courseDate="13 августа"
      />
      <FreeTrialBanner />
      <ScheduleSection />
      <AudienceSection />
