    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-secondary/5 py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
          <h1 className="text-4xl font-bold mb-8 text-center">Согласие на получение информационной и рекламной рассылки</h1>

          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            <p>
              Проставляя галочку в чек-боксе «согласен на получение рекламных рассылок» Вы даете свое согласие на получение
              информационной и рекламной рассылки от Индивидуального предпринимателя Кузиковой Светланы Алексеевны
            ...
            <p>
              Информационная и рекламная рассылка будет направляться с электронной почты Исполнителя на Вашу электронную
