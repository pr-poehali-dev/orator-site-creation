        ...
        <div className="p-8 md:p-12">
          ...
          {!downloaded ? (
            <>
              ...
              <div className="bg-gradient-to-br from-primary to-secondary text-white rounded-xl p-8 mb-8 relative overflow-hidden">
                <div className="absolute inset-0 bg-black/10"></div>
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold mb-4 text-center">Хотите узнать все 7 секретов?</h3>
                  <p className="mb-6 text-center text-lg">
                    Вы прочитали только 3 правила из 7! Получите полный гайд в PDF со всеми секретами харизматичного оратора:
                  </p>
                  <ul className="space-y-2 mb-6 max-w-xl mx-auto">
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle2" size={20} className="mt-1 flex-shrink-0" />
                      <span>Правило 4: Держи контакт с аудиторией</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle2" size={20} className="mt-1 flex-shrink-0" />
                      <span>Правило 5: Постановка на публике</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle2" size={20} className="mt-1 flex-shrink-0" />
                      <span>Правило 6: Поддерживай энергетику</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle2" size={20} className="mt-1 flex-shrink-0" />
                      <span>Правило 7: Делай паузы</span>
                    </li>
                  </ul>
          ...
          {downloaded && (
            <div className="bg-gradient-to-br from-primary to-secondary text-white rounded-xl p-8 mb-8">
              <div className="bg-green-50 rounded-xl p-6 text-center border-2 border-green-200 mb-6">
