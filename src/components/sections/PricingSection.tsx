  ...
  const packages = [
    {
      ...
      startDateNote: 'субботняя группа, сб 11:00–13:00',
      price: '19 500',
      oldPrice: '22 500',
      features: [
    ...
    },
    {
      ...
      duration: '12 групповых + 2 индивидуальных + онлайн курс по речевой креативности в подарок',
      durationText: 'Продолжительность: 1,5 месяца',
      startDate: '18 мая — 24 июня 2026',
      startDateNote: 'вечерняя группа, пн/ср 19:00–21:00',
      price: '24 000',
      oldPrice: '29 500',
      priceNote: '',
      features: [
        '12 групповых тренингов',
        '2 индивидуальных занятия',
        'Онлайн курс по речевой креативности в подарок',
        'Сторителлинг: умение рисовать словами',
        'Тренинги по импровизации и речевой креативности',
        'Актёрское мастерство для жизни и карьеры',
