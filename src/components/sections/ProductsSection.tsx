  ...
  const products = [
    {
      ...
      description: 'Практическое руководство для тех, кто хочет научиться выступать уверенно и убедительно',
      price: 'от 299 ₽',
      links: [
    ...
    },
    {
      ...
      description: 'Развитие творческого мышления и импровизации в публичных выступлениях',
      price: '490 ₽',
      links: [
