              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 my-2">
                    ...
                    <span className="text-gray-400 text-base">или</span>
                    <div className="flex-1 h-px bg-gray-200" />
                  </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-3 w-full bg-green-500 hover:bg-green-600 transition-colors text-white font-bold text-xl py-5 rounded-lg"
                  >
