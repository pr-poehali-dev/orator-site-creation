...
export const courses: Course[] = [
  {
    ...
    features: [
      ...
      'Онлайн курс «Запуск блогера» в подарок'
    ],
    topics: [
  ...
  },
  {
    ...
    startDate: 'Онлайн',
    startDate2: 'Офлайн',
    duration: 'Продолжительность занятия — 1 час. Программа корректируется по запросу',
    schedule: 'По согласованию',
    spots: 'Набор открыт',
    cardPrice: '5 000 ₽ за занятие',
