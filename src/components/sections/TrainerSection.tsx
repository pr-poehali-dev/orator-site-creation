...
const TrainerSection = () => {
  const achievements = [
    ...
    {
      icon: 'Brain',
      text: 'Профессиональный психолог — 15 лет опыта'
    },
    {
      icon: 'Award',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-8 md:mb-12">
          <div className="flex justify-center">
            <div className="relative max-w-md w-full">
              ...
              <img 
                src="https://cdn.poehali.dev/projects/982ce877-171e-45ff-91a1-ae753687e607/bucket/1643cbfc-7a78-4c40-958c-272c0d301abf.jpg"
